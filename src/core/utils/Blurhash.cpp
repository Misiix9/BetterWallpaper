/**
 * @file Blurhash.cpp
 * @brief Blurhash encoder/decoder — independent C++20 implementation
 *
 * Based on the public-domain blurhash algorithm specification.
...
std::string encode(const uint8_t *pixels, int width, int height,
  ...
  // Quantised maximum value (1 char)
  ...
  // Actual maximum for AC encoding
