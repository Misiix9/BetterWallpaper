...
private:
  ...
  std::unordered_map<std::string, WorkshopCard *>
      m_workshopCards; // workshopId → card
  ...
  void performSearch(const std::string &query, int page = 1,
  ...
  // Dialogs
  void showSteamLoginDialog(const std::string &prefillUser = "",
