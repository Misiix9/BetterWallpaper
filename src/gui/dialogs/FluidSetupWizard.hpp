...
private:
  ...
  static void onDraw(GtkDrawingArea *area, cairo_t *cr, int width, int height,
                     gpointer data);
  static gboolean onTick(GtkWidget *widget, GdkFrameClock *clock,
                         gpointer data);
  ...
  static gboolean onKeyPress(GtkEventControllerKey *controller, guint keyval,
                             ...
                             gpointer data);
  static void onInputFocusIn(GtkEventControllerFocus *controller,
                             gpointer data);
  static void onInputFocusOut(GtkEventControllerFocus *controller,
                              gpointer data);
};
} // namespace bwp::gui
